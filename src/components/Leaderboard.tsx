...
export const Leaderboard: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const subscription = supabase
      ...
      .on('postgres_changes' as any, { event: 'INSERT', schema: 'public', table: 'leaderboard' }, (payload: any) => {
        setScores(prev => [payload.new as Score, ...prev].sort((a, b) => b.score - a.score).slice(0, 5));
      })
      .subscribe();
