...
export const WordSearch: React.FC<{ username: string; onComplete: (score: number) => void }> = ({ username, onComplete }) => {
  ...
  return (
    <div className="p-6 bg-red-900/20 rounded-3xl border-4 border-yellow-600/30">
      ...
      <div className="grid grid-cols-10 gap-0.5 sm:gap-1 mb-6 max-w-full mx-auto aspect-square select-none">
        {grid.map((row, r) => row.map((char, c) => {
          ...
          return (
            <div
              ...
              className={`aspect-square flex items-center justify-center font-black text-[9px] sm:text-xs cursor-pointer rounded-sm transition-colors touch-none ${
